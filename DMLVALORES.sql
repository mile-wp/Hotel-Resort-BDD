...
VALUES 
('María', 'Gómez', '30111222', 'AA123456', 'maria.gomez@mail.com', '1111-1111', 'Inactivo'),
...
INSERT INTO ConsumoServicio (IDServicio, IDHabitacion, Cantidad)
VALUES
(1, 1, 1),  -- María usó Spa
...
-- Tarifas de servicio
INSERT INTO TarifaServicio (IDHabitacion, Subtotal)
VALUES
(1, 8000.00),
(2, 14000.00),
(3, 12000.00);
